...
class StorageService {
  ...
  String getPreferredMortar() {
    return getSetting<String>('preferred_mortar', defaultValue: 'M252') ?? 'M252';
  }
  ...
  Future<void> addToHistory(FiringSolution solution, Position mortar, Position target) async {
    await initialize();
